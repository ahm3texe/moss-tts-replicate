...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        max_new_tokens: int = Input(
            description="Üretilebilecek maksimum token sayısı. Çıktı ses uzunluğunu kontrol eder. Kural: 1 saniye ≈ 12.5 token. Örnek: 512 token ≈ ~40 saniye ses. Uzun metinler için artırın.",
            default=512,
            ge=64,
            le=8192
        ),
